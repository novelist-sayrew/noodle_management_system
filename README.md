...
### 2.商品の状態ごとにおけるランク分け
&nbsp; 賞味期限が5日以内の商品のみをソートし、別のページ(/noodle/warning)に一覧で表示されるようにしました。
また、ユーザーに危機感が伝わりやすいようにするために、賞味期限が切れた商品の商品名の一覧が、ページの上部に表示されるようにしました。



&nbsp; 商品を食べ終わった後に、ユーザーが、その商品情報を即座に削除することができるように、
